...
namespace Synthesis.FieldTypes.Adapters
{
    ...
    public class AxesAdapter : IAxesAdapter
    {
        ...
        {
            Item[] selectItems = _axes.SelectItems(query);
            return selectItems == null ? null : selectItems.AsStronglyTypedCollection();
        }

        public IStandardTemplateItem SelectSingleItem(string query)
        {
            Item selectSingleItem = _axes.SelectSingleItem(query);
            return selectSingleItem == null ? null : selectSingleItem.AsStronglyTyped();
        }
